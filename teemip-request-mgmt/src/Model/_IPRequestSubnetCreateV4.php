...
{
    /**
     * Handle After Write event on IPRequestSubnetCreateV4
     *
     * @param EventData $oEventData
     * @return void
     */
    public function OnIPRequestSubnetCreateV4AfterWriteRequestedByIpRequestMgmt(EventData $oEventData): void
    {
