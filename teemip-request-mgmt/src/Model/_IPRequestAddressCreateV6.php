...
{
    /**
     * Handle After Write event on IPRequestAddressCreateV6
     *
     * @param EventData $oEventData
     * @return void
     */
    public function OnIPRequestAddressCreateV6AfterWriteRequestedByIpRequestMgmt(EventData $oEventData): void
    {
